                      ...
                      <div class="card card-body">
                        ...
                        <?php else: ?>
                          ...
                          <ul class="list-unstyled">
                               <a href="<?php echo base_url('admin/sendmessagesview/').$londontecusers['user_id']; ?>" class="label label-default"><span class="glyphicon glyphicon-envelope"></span> Send Message</a>
                          </ul>
                      </div>
