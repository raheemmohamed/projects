...
<html>
  ...
  <body class="hold-transition login-page">
    <div class="londontec"></div>
      ...
      <div class="row">
           <div class="col-md-8">
             <img src="<?php echo base_url('assets/frontend/img/tech_staff.jpg');?>" alt="background" style="width: 102%;height: 101% !important;">
           </div>
        <div class="col-md-4">
          <div class="login">
            <div class="login-box">
              ...
              <div class="login-logo">
                <a href="#"><b>Londontec Admin LMS</b></a>
              </div><!-- /.login-logo -->
              <div class="login-box-body">
                <p class="login-box-msg">Admin Login for Londontec LMS</p>
              <form action='<?php echo base_url();?>login/process' method='post' name='process'>
                ...
                <?php echo validation_errors('<div class="alert alert-danger">', '</div>'); ?>
                  ...
                  <div class="row">
                    <div class="col-xs-8">
                        <a href="http://www.londonteclms.tk/student" style="text-align: center;">Go Back to Student Login</a>
                    </div><!-- /.col -->
                    <div class="col-xs-4">
