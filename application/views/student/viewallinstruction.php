          ...
          <?php echo $this->session->flashdata('msg'); ?>
           ...
           <?php foreach($instructionlist as $instructure):?>
            <?php foreach($courselist as $courses):?>
              ...
              <?php if($instructure['course_id'] == $this->session->userdata('course_id')):?>
                <div class="mdl-card mdl-shadow--2dp demo-card-square">
                  ...
                  <div class="mdl-card__actions mdl-card--border">
                    <a href="<?php echo base_url('student/instruction_meterials/').$instructure['instruct_id']; ?>" class="mdl-button mdl-button--accent mdl-js-button mdl-js-ripple-effect" >
                        Open
                      </a>
