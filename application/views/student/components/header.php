...
<html>
  <head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url('assets/frontend/img/'); ?>londontec.gif">
       ...
       <!-- jquery calender-->
    <link rel="stylesheet" href="<?php echo base_url('assets/calender/'); ?>calendar.css">
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <!-- Logo -->
        <a href="<?php echo base_url('student'); ?>" class="logo">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <?php if($this->session->userdata('Gender') == 1):?>
                  <img src="<?php echo base_url('assets/frontend/img'); ?>/malestudent.png" class="user-image" alt="studentmale">
                  <?php else:?>
                  <img src="<?php echo base_url('assets/frontend/img'); ?>/femalestudent.png" class="user-image" alt="studentfemale">
                <?php endif;?>
                ...
                <?php endif;?>
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-left">
                      <a href="<?php echo base_url('student/profile/'.$student_id)?>" class="btn btn-default btn-flat">Profile Settings</a>
                    </div>
                    <div class="pull-right">
                      <a href="<?php echo base_url('student_login/logout')?>" class="btn btn-danger btn-flat">Logout</a>
                    </div>
                  </li>
                </ul>
              </li>
